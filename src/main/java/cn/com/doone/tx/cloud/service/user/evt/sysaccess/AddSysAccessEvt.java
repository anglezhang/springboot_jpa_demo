...
public class AddSysAccessEvt extends BaseEvt implements Serializable {
	...
	public String toString() {
		return "AddSysAccessEvt [sysName=" + sysName + ", sysCode=" + sysCode + ", sysKey=" + sysKey + ", loginUrl="
				+ loginUrl + ", successUrl=" + successUrl + ", pwdUrl=" + pwdUrl + ", overSeconds=" + overSeconds
				+ ", extendMin=" + extendMin + ", menuId=" + menuId + ", creator=" + creator + ", languageType="
				+ languageType + "]";
	}
