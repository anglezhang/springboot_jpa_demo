 ...
 * @version V1.0
 * @Title: CustomGroupExtendInfoBean
 * @Package cn.com.doone.tx.cloud.user.service.bean.sys
 * @Description: 自定义用户组扩展表
 * @date 2017年4月17日 下午5:35:59
 */
@Entity
@Table(name = "ts_custom_group_extend_info")
@SequenceGenerator(name="common_generator",sequenceName="s_ts_custom_group_extend_info", // oracle 用到的序列名 s_config_code
        allocationSize=1,initialValue=1) // 主键生成策略,sequenceName为s_表名,其他不用动
public class CustomGroupExtendInfoBean extends PlatBaseEntity implements Serializable {

    private static final long serialVersionUID = 8438789991320653601L;

    /** 用户组ID */
    @Column(name="CUSTOM_GROUP_ID",nullable = false)
