 ...
 */
@Entity
@Table(name = "ts_staff_group_extend_info")
@SequenceGenerator(name="common_generator",sequenceName="s_ts_staff_group_extend_info", // oracle 用到的序列名 s_config_code
        allocationSize=1,initialValue=1) // 主键生成策略,sequenceName为s_表名,其他不用动
public class StaffGroupExtendInfoBean extends PlatBaseEntity implements Serializable {


    private static final long serialVersionUID = 6772896041320718697L;
    /** 用户组ID */
    ...
    public String toString() {
        return "StaffGroupExtendInfoBean{" +
                "groupId=" + groupId +
                ", field1='" + field1 + '\'' +
                ", field2='" + field2 + '\'' +
                ", field3='" + field3 + '\'' +
