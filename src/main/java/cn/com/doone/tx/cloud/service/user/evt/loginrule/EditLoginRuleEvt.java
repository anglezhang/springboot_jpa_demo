...
public class EditLoginRuleEvt extends BaseEvt implements Serializable{ 
	
	private static final long serialVersionUID = 4116000401446863744L;
	/**
	 * 主键ID
     */
    @Field(value="主键ID", length = 10, nullable = false)
    private Long id;
    /**
	 * 适用类型  B:业务系统  A:APP
     */
