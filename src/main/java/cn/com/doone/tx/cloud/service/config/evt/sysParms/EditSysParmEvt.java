 ...
 */
public class EditSysParmEvt extends BaseEvt {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2814871878809454075L;
	...
	/** 系统参数值序号 */
	@Field(nullable = true, length = 10, value = "系统参数值序号")
	private Long sort;

	/** 参数类型0 key信息；1 key-value信息 */
	@Field(nullable = true, length = 10, value = "参数类型")
	private Long type;
